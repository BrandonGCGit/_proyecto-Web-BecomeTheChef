                        ...
                        <form action="_recipes_update.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="recipe_name" class="form-label">Nombre de la
                                    receta</label>
                                <input type="text" class="bg-gray form-control" name="recipe_name" value="<?php echo $data_recipes[0]["recipes_name"]; ?>">
                            </div>
                            <!--////////////////////////////////////-->
                            <!--RECIPE NAME INPUT-->
                            <!--////////////////////////////////////-->
                            ...
                            <div class="container px-0 d-flex justify-content-between mt-5 align-items-end">
                                ...
                                <div class="col-6 ps-2">
                                    ...
                                    <select class="bg-gray form-select" aria-label="Default select example" name="recipe_complexity">
                                        ...
                                        for($i=0; $i < $len; $i++){
                                            if($data_recipes[0]["complexity_id"] === $data_Complexity[$i]['complexity_id']){
                                                 echo '<option id="recipe_complexity" value="'.$data_Complexity[$i]
                                                ['complexity_id'].'" selected>'.$data_Complexity[$i]//El select permite que la receta seleccionada se ponga de primera
                            ...
                            <div class="container px-0 d-flex justify-content-between mt-5 align-items-end">
                                <div class="col-6 pe-2">
                                    ...
                                    <input type="text" class="bg-gray form-control" id="recipe_timePreparation"
                                           ...
                                           value="<?php echo $data_recipes[0]["recipes_preparation_time"]; ?>">
                                </div>
                                ...
                                <div class="col-6 ps-2">
                                    ...
                                    <select class="bg-gray form-select" aria-label="Default select example" name="recipe_category">
                                        ...
                                        for($i=0; $i < $len; $i++){
                                            if($data_recipes[0]["category_id"] === $data_Category[$i]['category_id']){
                                                echo '<option id="recipe_category"  value="'.$data_Category[$i]
                                                ['category_id'].'" selected>'.$data_Category[$i]
                            ...
                            <div class="container px-0 d-flex justify-content-between mt-5 align-items-end">
                                <div class="col-6 pe-2">
                                    ...
                                    <input type="text" class="bg-gray form-control" id="recipe_cookingTime"
                                           placeholder="Ingrese el tiempo de cocción" name="recipe_cookingTime" value="<?php echo $data_recipes[0]['recipes_cooking_time'];?>">
                                </div>
                                ...
                                <div class="col-6 ps-2">
                                    ...
                                    <select class="bg-gray form-select" aria-label="Default select example" name="recipe_occasion">
                                        ...
                                        for($i=0; $i < $len; $i++){
                                            if($data_recipes[0]['occasion_id'] === $data_Occasion[$i]['occasion_id']){
                                                echo '<option id="recipe_occasion" value="'.$data_Occasion[$i]
                                                ['occasion_id'].'" selected>'.$data_Occasion[$i]
                            ...
                            <div class="container px-0 d-flex justify-content-between mt-5 align-items-end">
                                <div class="col-6 pe-2">
                                    ...
                                    <input type="text" class="bg-gray form-control" id="recipe_totalTime"
                                           placeholder="Ingrese el tiempo Total" name="recipe_totalTime" value="<?php echo $data_recipes[0]['recipes_total_time']?>">
                                </div>
                                ...
                                <div class="col-6 ps-2">
                                    ...
                                    <select class="bg-gray form-select" aria-label="Default select example" name="recipe_isFeatured">
                                        ...
                                        <?php
                                        if($data_recipes[0]["recipes_isFeatured"] == 0){
                            ...
                            <div class="container px-0 d-flex justify-content-between mt-5 align-items-end">
                                <div class="col-6 pe-2">
                                    ...
                                    <input type="text" class="bg-gray form-control" id="recipe_portions"
                                           placeholder="Ingrese la cantidad de porciones" name="recipe_portions" value="<?php echo $data_recipes[0]['recipes_portions']?>">
                                </div>
                                <div class="col-6 ps-2">
                                    <label for="recipe_likes" class="form-label">Votos</label>
                                    <input type="text" class="bg-gray form-control" id="recipe_likes"
                                           placeholder="Ingrese los votos de la receta" name="recipe_likes" value="<?php $data_recipes[0]['recipes_likes']?>">
                                </div>
                            </div>
                            <!--////////////////////////////////////-->
                            <!--PORTIONS AND VOTES-->
                            ...
                            <div class="container px-0 mt-5">
                                ...
                                <textarea type="text" class="bg-gray form-control" id="recipe_description"
                                          rows="6" name="recipe_description">
